<template>
  <aside :class="['sidebar', { open: isOpen }]">
    ...
    <div class="logo-container">
      <img src="/sidebar/nutricontrol-sidebar-logo.png" width="180" height="90" alt="Logo" />
    </div>
    <hr class="separator" />
    <nav class="nav-links">
      ...
      <router-link to="/campos-agricolas" class="nav-link">
...
.nav-link { display: flex; align-items: center; gap: 15px; font-size: 20px; font-weight: 600; color: white; text-decoration: none; }
